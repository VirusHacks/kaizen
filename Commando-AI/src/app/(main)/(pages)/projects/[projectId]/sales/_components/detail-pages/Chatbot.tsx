...
export default function Chatbot({
  ...
  const quickQuestions =
    QUICK_QUESTIONS[pageTitle as keyof typeof QUICK_QUESTIONS] ||
    QUICK_QUESTIONS['Revenue Analytics'];
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (
          ...
          throw new Error(
            'AI Assistant is not configured. Please add GOOGLE_AI_API_KEY to your environment variables.',
          );
        }

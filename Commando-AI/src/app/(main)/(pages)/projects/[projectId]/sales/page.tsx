...
import { TrendingUp, ArrowLeft, FolderKanban } from 'lucide-react'
...
const SalesDashboard = async ({ params }: Props) => {
      ...
      <div className="p-6">
        <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
          ...
          <p className="text-muted-foreground text-center max-w-md">
            Welcome to the Sales Dashboard. This view is customized for sales teams
            to track leads, opportunities, and revenue targets.
          </p>
